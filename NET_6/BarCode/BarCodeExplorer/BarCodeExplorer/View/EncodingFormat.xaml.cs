...
namespace BarCodeExplorer
{
    ...
    public partial class EncodingFormat : UserControl
    {
        ...
        private void CreateCategories()
        {
            ...
            {
                Categories.Add(new Category("../Images/Email.png", "Email", Format.Email));
                Categories.Add(new Category("../Images/Text.png", "Text", Format.Text));
                Categories.Add(new Category("../Images/Url.png", "Url", Format.Url));
                Categories.Add(new Category("../Images/VCard.png", "VCard", Format.VCard));
            }
        }
        ...
        private void CreateCodeTypes()
        {
            ...
            {
                CodeTypes.Add("../Images/QRCode.png", CodeType.QRCode);
                CodeTypes.Add("../Images/DataMatrix.png", CodeType.DataMatrix);
                CodeTypes.Add("../Images/PDF417.png", CodeType.Pdf417);
                CodeTypes.Add("../Images/Code39X.png", CodeType.Code39x);
            }
        }
