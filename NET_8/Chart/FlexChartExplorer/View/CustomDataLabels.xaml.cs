...
#pragma warning disable 1591
    public sealed partial class CustomDataLabels : UserControl
    {
        ...
        void LabelRendering(object sender, C1.WinUI.Chart.RenderDataLabelEventArgs args)
        {
            // skip labels according to the gap
            var gap = Gaps[cbGaps.SelectedIndex];
