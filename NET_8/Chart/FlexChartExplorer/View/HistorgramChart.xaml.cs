...
#pragma warning disable 1591
    public sealed partial class HistogramChart : UserControl
    {
        List<Point> _data;
        ...
        void NormalChecked(object sender, RoutedEventArgs args) => histogram.NormalCurve.Visible = true;
        void NormalUnchecked(object sender, RoutedEventArgs args) => histogram.NormalCurve.Visible = false;

        void CumulativeChecked(object sender, RoutedEventArgs args) => histogram.CumulativeMode = true;
        void CumulativeUnchecked(object sender, RoutedEventArgs args) => histogram.CumulativeMode = false;
