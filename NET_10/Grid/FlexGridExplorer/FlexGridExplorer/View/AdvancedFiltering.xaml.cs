...
namespace FlexGridExplorer
{
    ...
    public partial class AdvancedFiltering : UserControl
    {
        ...
        private void OnTabChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            var tabControl = sender as TabView;
        ...
        private void OnFilterAutoGenerating(object sender, C1.WinUI.DataFilter.FilterAutoGeneratingEventArgs e)
        {
            if(e.Property.Name == nameof(TaskItem.AssignTo) || e.Property.Name == nameof(TaskItem.OwnedBy))
            {
                e.Filter = new C1.WinUI.DataFilter.FullTextFilter() { PropertyName = e.Property.Name };
            }
        }
    }
}
