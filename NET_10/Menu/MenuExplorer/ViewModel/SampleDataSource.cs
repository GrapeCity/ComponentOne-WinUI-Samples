    ...
    public class SampleDataSource
    {
        public SampleDataSource()
        {
            AllItems = new ObservableCollection<SampleItem>
            {
                ...
                new SampleItem(AppResources.GroupingTitle,
                                AppResources.GroupingTitle,
                                new System.Lazy<UserControl>(() => new Grouping())),
                new SampleItem(AppResources.DropDownMenuTitle,
                                AppResources.DropDownMenuTitle,
                                new System.Lazy<UserControl>(() => new DropDownMenu())),
