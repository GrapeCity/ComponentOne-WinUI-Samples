    ...
    public class AxisBreakHelper
    {
        ...
        class AxisBreak
        {
            ...
            void CreatePlotAreas(double min1, double max1, double min2, double max2, double size, double gapPixels)
            {
                ...
                {
                    var pa1 = new PlotArea() { Column = 0, PlotAreaName = "pa1", 
                        Width = new Microsoft.UI.Xaml.GridLength(size, Microsoft.UI.Xaml.GridUnitType.Star) };
                    var paBreak = new PlotArea() { Column = 1, PlotAreaName = "pabreak", 
                        Width = new Microsoft.UI.Xaml.GridLength(gapPixels) };
                ...
                {
                    var pa1 = new PlotArea() { Row = 2, PlotAreaName = "pa1", 
                        Height = new Microsoft.UI.Xaml.GridLength(size, Microsoft.UI.Xaml.GridUnitType.Star) };
                    var paBreak = new PlotArea() { Row = 1, PlotAreaName = "pabreak", 
                        Height = new Microsoft.UI.Xaml.GridLength(gapPixels) };
            ...
            void DrawBreakArea(IRenderEngine engine, double x1, double y1, double x2, double y2, bool rotated = false)
            {
                ...
                engine.SetFill( (chart.XamlRoot.Content as Grid)?.Background);
