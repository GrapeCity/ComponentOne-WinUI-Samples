...
namespace FlexChartExplorer.Resources {
    ...
    public class AppResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The sample displays the same data on two plot areas simulating axis break. Custom axis appearance and &apos;break area&apos; are drawn in chart Rendered event handler..
        /// </summary>
        public static string AxisBreakDescription {
            get {
                return ResourceManager.GetString("AxisBreakDescription", resourceCulture);
            }
        }
        ...
        /// </summary>
        public static string AxisBreakHeader {
            get {
                return ResourceManager.GetString("AxisBreakHeader", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Shows contour chart of the given data. The 2D data is grouped into isoareas based on it&apos;s contour values. .
        /// </summary>
        public static string ContourDescription {
            get {
                return ResourceManager.GetString("ContourDescription", resourceCulture);
            }
        }
