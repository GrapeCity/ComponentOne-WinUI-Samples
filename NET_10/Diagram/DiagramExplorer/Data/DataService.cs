...
#pragma warning disable 1591
    ...
    public class OrgNode
    {
        ...
        public BitmapImage Image
        {
            get
            {
                if (!imageLoaded)
                {
                    image = new BitmapImage(new Uri(@"ms-appx:///Resources/" + Name.Replace(' ', '_') + ".png"));
                    imageLoaded = true;
                }
    ...
    public class Country
    {
        ...
        public BitmapImage Flag
        {
            ...
            {
                if (flag == null)
                    flag = new BitmapImage(new Uri(@$"ms-appx:///Resources/flags/{Code}.png"));
    ...
    public class DataService
    {
        ...
        public static List<OrgNode> GetOrgChartData()
        {
