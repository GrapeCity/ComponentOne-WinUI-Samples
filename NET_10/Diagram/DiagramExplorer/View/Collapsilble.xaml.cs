...
#pragma warning disable 1591
    public sealed partial class Collapsible : UserControl, IDiagramHolder
    {
        public Collapsible()
        {
            InitializeComponent();
            ...
            diagram.NodeCreated += (s, args) =>
            {
                ...
                if (country != null && country.Flag != null)
                {
                    ...
                    node.TitleImageAlignment = ContentAlignment.MiddleCenter;
                    node.TitleImageSize = new Windows.Foundation.Size(16, 16);
                }
            ...
            {
                var position = e.GetCurrentPoint(diagram).Position;
